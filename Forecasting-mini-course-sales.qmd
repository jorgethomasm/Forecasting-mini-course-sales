...
sales_fc %>% 
  ...
  labs(title = "Canada Sales of Improve Your Coding course on Kagglazon")


sales_fc %>% 
  filter(.model == "ets", country == "Japan", store == "Kagglazon", product == "Improve Your Coding") %>% 
  autoplot(sales, level = NULL) +
  labs(title = "Japan's Kagglazon sales of Improve Your Coding course on Kagglazon")


sales_fc %>% 
  filter(.model == "ets", country == "Argentina", store == "Kagglazon", product == "Improve Your Coding") %>% 
  autoplot(sales, level = NULL) +
  labs(title = "Argentinas' Kagglazon sales of Improve Your Coding course on Kagglazon")
